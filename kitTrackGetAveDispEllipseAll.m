function [longVecS,longVecE,shortVecS,shortVecE,shortVecS3D,shortVecE3D] = ...
    kitTrackGetAveDispEllipseAll(xyzVel,brownStd,trackType,undetBrownStd,timeWindow,...
...
%                    ends of tracks.
%        shortVecS3D:Vector defining 2nd short radius of search
%        ellipse/ellipsoid at th e
%                   starts of tr acks in case of 3D.
%       shortvecE3D:Vector defin ing 2nd short radius of search
%       ellipse/ellipsoid at th e
%                   ends of tra cks in case of 3D.
%       errFlag   : 0 if functi on executes normally, 1 otherwise
% 
...
if nargin ~= nargin('kitTrackGetAveDispEllipseAll')
    disp('--kitTrackGetAveDispEllipseAll: Incorrect number of input arguments!');
    return
end
