function jobset=kitUpdateOptions(jobset,mode)
% KITUPDATEOPTIONS Displays GUI to allow user to update JOBSET options.
%
% For debugging, use jobset=kitUpdateOptions(jobset,'debug').
%
