function [costMat,nonlinkMarker,indxMerge,numMerge,indxSplit,numSplit,...
    errFlag] = kitTrackCostMatCloseGaps(trackedFeatInfo,...
...
% KITTRACKCOSTMATCLOSEGAPS provides a cost matrix for closing gaps in tracking HeLa kinetochores
%
...
%                         [x1 y1 z1 a1 dx1 dy1 dz1 da1 x2 y2 z2 a2 dx2 dy2
%                         dz2 da2 ... ]
...
if nargin ~= nargin('kitTrackCostMatCloseGaps')
    disp('--kitTrackCostMatCloseGaps: Incorrect number of input arguments!');
    errFlag  = 1;
    return
end
...
[longVecSAll,longVecEAll,shortVecSAll,shortVecEAll,shortVecS3DAll,...
    shortVecE3DAll] = kitTrackGetAveDispEllipseAll(xyzVel,noiseStd,trackType,...
