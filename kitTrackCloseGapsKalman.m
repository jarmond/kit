function [tracksFinal,kalmanInfoLink,errFlag] = kitTrackCloseGapsKalman(...
...
if selfAdaptive
    ...
    [~,~,kalmanInfoLink,~,linkingCosts] = linkFeaturesKalman(...
        movieInfo,costMatrices(1).funcName,costMatrices(1).parameters,...
        kalmanFunctions,probDim,[],[]);
    ...
    [~,~,kalmanInfoLink,~,linkingCosts] = linkFeaturesKalman(...
        ...
        kalmanFunctions,probDim,kalmanInfoLink,linkingCosts);
    ...
    [tracksFeatIndxLink,tracksCoordAmpLink,kalmanInfoLink,nnDistLinkedFeat,...
        ~,errFlag] = linkFeaturesKalman(movieInfo,costMatrices(1).funcName,...
        costMatrices(1).parameters,kalmanFunctions,probDim,...
        kalmanInfoLink,linkingCosts);
