...
function hs = createControls()
  ...
  hs.fig.MenuBar = 'none';
  hs.fig.Name = ['KiD ' kitVersion(1) ' - Check metadata'];
  ...
  % dimensions panel
  hs.dimensionsPanel = uipanel(hs.fig,'Units','characters','Position',[x y-6.75*h w 6.25*h],'FontSize',tinyfont,'Title','Movie dimensions');
