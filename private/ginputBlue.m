function [out1,out2,out3] = ginputBlue(arg1)
...
%   See https://uk.mathworks.com/matlabcentral/answers/370528-controlling-the-color-of-crosshair-raised-by-ginput
%   Jonathan U Harrison 2020-03-11
...
for k = 1:4
    crossHair(k) = uicontrol(fig, 'Style', 'text', 'Visible', 'off', 'Units', 'pixels', 'BackgroundColor', [0.01 0.01 0.99], 'HandleVisibility', 'off', 'HitTest', 'off'); %#ok<AGROW>
end
end
